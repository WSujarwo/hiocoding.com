...
@endif
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input disabled type="text" name="tanggal_order" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php if(isset($_POST['tanggal_order'])) { echo old('tanggal_order'); }else{ echo date('d-m-Y'); } ?>">
              </div>
            </div>
            ...
            <div class="col-md-12">
               <hr>
               <p>Kami akan segera menghubungi Anda untuk melakukan konfirmasi seputar pesanan Anda.</p>
                <!--<p>Anda sudah melakukan pembayaran? Silakan lakukan 
                  <a href="{{ asset('konfirmasi') }}">Konfirmasi Pembayaran</a>.
                </p> -->
                <hr>
             </div>     
          </div>
