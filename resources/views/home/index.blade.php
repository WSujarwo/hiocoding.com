<section id="hero" style="color: #fff; background-color: deepskyblue !important">
  <div class="container">
    <div class="row">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-4 col-lg-6 d-flex justify-content-center align-items-stretch" data-aos="fade-right">
            <img src="{{ asset('public/upload/image/'.$site->icon) }}" alt="{{ $site->namaweb }}" class="img img-fluid" height="300">
          </div>
          ...
          <div class="col-xl-8 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3 class="text-warning">Selamat datang di {{ $site->namaweb }}</h3>
...
<section id="apa-itu-nitrico" class="about bg-success">
  <div class="container">
    <div class="col-xl-12 col-lg-12 col-md-12 text-center " data-aos="fade-up">
          <!-- <h2>Produk <?php $site->namaweb ?></h2> -->
          <h2 class="text-warning">Produk dan Layanan</h2>
          <p class="px-5 text-light"><?php echo $site->deskripsi ?></p>
          <!-- <p class="text-justify">Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Voluptatibus aliquam ut nemo, ipsa quam asperiores quae ab accusantium placeat provident quaerat quia qui tenetur nulla vitae, adipisci, voluptate sint. Modi.</p> -->
          <br><br>
    </div>
        <!-- START -->
    <div class="row kotak1 bg-light">
      <?php  
            if($produks) {
          ...
          <?php  
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 berita">
                  ...
                  <div class="keterangan">
                    ...
                    <p class="harga"><?php echo \Illuminate\Support\Str::limit(strip_tags($berita->isi), 200, $end='...') ?></p>
